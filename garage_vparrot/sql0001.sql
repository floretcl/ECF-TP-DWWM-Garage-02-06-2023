...
--
CREATE TABLE "garage_customermessage" (
...
--
CREATE TABLE "garage_customerreview" (
    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, 
...
--
CREATE TABLE "garage_vehiclepicture" (
    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, 
...
--
CREATE TABLE "garage_openingtime" (
...
ALTER TABLE "garage_service" ADD CONSTRAINT "garage_service_garage_id_344958d0_fk_garage_garage_name" FOREIGN KEY ("garage_id") REFERENCES "garage_garage" ("name") DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX "garage_service_garage_id_344958d0" ON "garage_service" ("garage_id");
CREATE INDEX "garage_service_garage_id_344958d0_like" ON "garage_service" ("garage_id" varchar_pattern_ops);
